    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Token = table.Column<string>(type: "nvarchar(21)", maxLength: 21, nullable: false),
                    ...
                    ParentToken = table.Column<string>(type: "nvarchar(21)", maxLength: 21, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RefreshTokens", x => x.Token);
                    table.ForeignKey(
                        name: "FK_RefreshTokens_RefreshTokens_ParentToken",
                        column: x => x.ParentToken,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RefreshTokens_ParentToken",
                table: "RefreshTokens",
                column: "ParentToken");
